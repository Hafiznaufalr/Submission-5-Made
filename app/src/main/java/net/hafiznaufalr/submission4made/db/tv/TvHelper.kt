...
import net.hafiznaufalr.submission4made.db.tv.TvContract.MovieColumns.Companion.FIRSTAIRDATE
import net.hafiznaufalr.submission4made.db.tv.TvContract.MovieColumns.Companion.ID
import net.hafiznaufalr.submission4made.db.tv.TvContract.MovieColumns.Companion.NAME
import net.hafiznaufalr.submission4made.db.tv.TvContract.MovieColumns.Companion.OVERVIEW
import net.hafiznaufalr.submission4made.db.tv.TvContract.MovieColumns.Companion.POPULARITY
import net.hafiznaufalr.submission4made.db.tv.TvContract.MovieColumns.Companion.POSTERPATH
import net.hafiznaufalr.submission4made.db.tv.TvContract.MovieColumns.Companion.VOTEAVERAGE
