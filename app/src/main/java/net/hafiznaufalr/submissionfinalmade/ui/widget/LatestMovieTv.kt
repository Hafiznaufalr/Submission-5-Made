...
class LatestMovieTv : AppWidgetProvider() {
    ...
    companion object {
        ...
        val TOAST_ACTION = "net.hafiznaufalr.submissionfinalmade.TOAST_ACTION"
        val EXTRA_ITEM = "net.hafiznaufalr.submissionfinalmade.EXTRA_ITEM"
