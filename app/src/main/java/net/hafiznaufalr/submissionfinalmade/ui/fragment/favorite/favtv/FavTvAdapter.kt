package net.hafiznaufalr.submissionfinalmade.ui.fragment.favorite.favtv
...
class FavTvAdapter(private val context: Context?,
                   private val data : List<Tv>,
                   private val onClickListener: (Tv) -> Unit)
    : RecyclerView.Adapter<FavTvAdapter.MyHolder>(){
